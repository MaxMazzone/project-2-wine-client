...
var makeWine = function makeWine(data) {
  return $.ajax({
...
var editWine = function editWine(data, wineId) {
  return $.ajax({
...
var deleteWine = function deleteWine(data, wineId) {
  return $.ajax({
    url: config.apiOrigin + '/wines/' + wineId,
    method: 'DELETE',
    headers: {
...
var callGoogle = function callGoogle(name, region, vintage) {
  return $.ajax({
...
var wineEvents = __webpack_require__(18);
...
var onMakeWine = function onMakeWine(event) {
  event.preventDefault();
  $('#make-wine-price').val().replace(/\$/g, '');
  var data = getFormFields(this);
  // console.log('button working')
  // console.log(data)
  api.makeWine(data).then(ui.MakeWineSuccess).catch(ui.MakeWineFailure);
};

var onGetWines = function onGetWines(event) {
  event.preventDefault();
  $('.content').slideToggle();
  api.getWines().then(ui.getWinesSuccess).catch(ui.getWinesFailure);
};
...
var showWines = __webpack_require__(20);
var api = __webpack_require__(7);
var getFormFields = __webpack_require__(4);

var MakeWineSuccess = function MakeWineSuccess(data) {
  // console.log('make wine success')
  // console.log(data)
  $('#make-wine').trigger('reset');
  api.getWines().then(getWinesSuccess).catch(getWinesFailure);
};
var MakeWineFailure = function MakeWineFailure() {
...
var getWinesSuccess = function getWinesSuccess(data) {
  // console.log(data)
  // console.log('You got all the wines')
  // console.log(data.wines.length)
  $('.content').empty();
  $('#research-message').empty();
  var showWinesHtml = showWines({ wines: data.wines });
...
var onResearchButtonClick = function onResearchButtonClick(event) {
  var wineId = $(this).parent().parent().data('id');
  event.preventDefault();
...
var onResearchClick = function onResearchClick(event) {
  var data = getFormFields(this);
  // const wineData = data.wine
  event.preventDefault();
  // console.log(data.wine.name)
  api.callGoogle(data.wine.name, data.wine.region_name, data.wine.vintage).then(callGoogleSuccess).catch(callGoogleFailure);
};

var noWinesCreated = function noWinesCreated() {
  $('#content-message').css('display', 'inline-block');
  $('#content-message').show();
...
var onDeleteWineClick = function onDeleteWineClick(data) {
  var wineId = $(this).parent().parent().data('id');
  // console.log('this will delete wine # ' + wineId)
  $(this).parent().parent().remove();
  api.deleteWine(data, wineId).then(deleteWinesSuccess).catch(deleteWinesFailure);
};
var onEditWine = function onEditWine(event) {
  var data = getFormFields(this);
  // const wineData = data.wine
  event.preventDefault();
  var wineId = $(this).parent().data('id');
  // console.log('button working ' + 'data is ' + data)
  // console.log(data)
  api.editWine(data, wineId).then(editWineSuccess).catch(editWineFailure);
};
...
var getWinesFailure = function getWinesFailure() {
  $('#content-message').show();
  $('#content-message').text('Unable to get wines');
  $('#content-message').delay(2000).fadeOut('2000');
};
var editWineSuccess = function editWineSuccess(data) {
  // console.log('edit wine success')
  // console.log(data)
  $('#edit-wine').trigger('reset');
  api.getWines().then(getWinesSuccess).catch(getWinesFailure);
};
var editWineFailure = function editWineFailure() {
  // console.log('edit wine failure')
  $('#content-message').show();
  $('#content-message').text('Unable To Edit Wine');
  $('#content-message').delay(2000).fadeOut('2000');
};
var deleteWinesSuccess = function deleteWinesSuccess(data) {
  // console.log('delete wine success')
  api.getWines().then(getWinesSuccess).catch(getWinesFailure);
};
var deleteWinesFailure = function deleteWinesFailure() {
  // console.log('delete wine failure')
  $('#content-message').show();
  $('#content-message').text('Unable To Delete Wine');
  $('#content-message').delay(2000).fadeOut('2000');
};
var callGoogleSuccess = function callGoogleSuccess(data) {
  $('#research-message').empty();
  $('#research-message').show();
  var name = data.items[0].pagemap.product[0].name;
  var price = data.items[0].pagemap.pricespecification[0].price;
  var currency = data.items[0].pagemap.pricespecification[0].pricecurrency;
  var format = data.items[0].pagemap.pricespecification[0].description;
  var vintage = data.items[0].pagemap.product[0].model;
  if (name === undefined) {
    name = '';
  }
  if (price === undefined) {
...
var callGoogleFailure = function callGoogleFailure() {
  $('#research-message').empty();
  $('#research-message').show();
...
module.exports = {
  MakeWineSuccess: MakeWineSuccess,
  MakeWineFailure: MakeWineFailure,
  getWinesFailure: getWinesFailure,
  getWinesSuccess: getWinesSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "\n  Don't uncomment yet -->\n\n\n  <ul data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <li> 🍷 <span class=\"wine-category\"> Name:</span> <strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</strong> <span class=\"wine-category\"> Region:</span> <strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.region_name : stack1), depth0))
    + "</strong> <span class=\"wine-category\"> Vintage:</span> <strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.vintage : stack1), depth0))
    + "</strong> <span class=\"wine-category\"> Notes: </span> <strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "</strong> <span class=\"wine-category\">  Price:</span><strong> $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + "</strong>   <button class= \"edit-wine-show btn btn-info btn-xs\">edit</button>    <button class= \"delete-wine btn btn-danger btn-xs\">Delete</button> <button class= \"research-wine-button btn btn-info btn-xs\">Research Wine</button></li>\n    <form class=\"edit-wine form-inline\" id=\"edit-wine-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" >\n          <fieldset>\n            <input type=\"text\" name=\"wine[name]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n            <input type=\"text\" name=\"wine[region_name]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.region_name : stack1), depth0))
    + "\">\n            <input type=\"number\" name=\"wine[vintage]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.vintage : stack1), depth0))
    + "\">\n            <input type=\"text\" name=\"wine[notes]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n            <input type=\"number\" name=\"wine[price]\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + ">\n            <input type=\"submit\" name=\"submit\" class=\"btn btn-primary\" value=\"Edit Wine\">\n          </fieldset>\n      </form>\n      <form class=\"research-wine form-inline\" id=\"research-wine-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" >\n            <fieldset>\n              <input type=\"hidden\" name=\"wine[name]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n              <input type=\"hidden\" name=\"wine[region_name]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.region_name : stack1), depth0))
    + "\">\n              <input type=\"hidden\" name=\"wine[vintage]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.vintage : stack1), depth0))
    + "\">\n              <input type=\"hidden\" name=\"wine[notes]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n              <input type=\"hidden\" name=\"wine[price]\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + ">\n              <input type=\"hidden\" name=\"submit\" class=\"btn btn-info btn-xs\" value=\"Research Wine\">\n            </fieldset>\n        </form>\n  </li>\n  </ul>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.wines : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
